...
[`@aws-sdk/client-kinesis-analytics-v2`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-analytics-v2/v/3.691.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-analytics-v2@3.691.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sN8JYyfIvUsTVCApOjTnDdsVr3b5gGSP+paUw+D9DS1m35jbbRDab0eL9PUQmzwa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-analytics-v2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-analytics-v2@3.691.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-analytics-v2@3.691.0/index.min.mjs": "sha384-sN8JYyfIvUsTVCApOjTnDdsVr3b5gGSP+paUw+D9DS1m35jbbRDab0eL9PUQmzwa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-analytics-v2/blob/refs/tags/3.691.0/LICENSE
```
