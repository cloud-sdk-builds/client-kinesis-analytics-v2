...
[`@aws-sdk/client-kinesis-analytics-v2`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-analytics-v2/v/3.1083.0).
...
- @aws-sdk/client-kinesis-analytics-v2 v3.1083.0 - [https://cloud-sdk-builds.github.io/?sdk=client-kinesis-analytics-v2&version=3.1083.0](https://cloud-sdk-builds.github.io/?sdk=client-kinesis-analytics-v2&version=3.1083.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-analytics-v2@3.1083.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0OBHKL0yC+DVv0gYByIlk418s3tKERgtdvL+WBfA3jAQhVre8hV+pFiMSpf/P+hc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-analytics-v2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-analytics-v2@3.1083.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-analytics-v2@3.1083.0/index.min.mjs": "sha384-0OBHKL0yC+DVv0gYByIlk418s3tKERgtdvL+WBfA3jAQhVre8hV+pFiMSpf/P+hc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-analytics-v2/blob/refs/tags/3.1083.0/LICENSE
```
